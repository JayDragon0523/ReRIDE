...
public class Fragment2 extends Fragment {
    ...
    private LinearLayout baidumap,todayOnceView, toolToday, toolOnce, toolTotal, onceTitleView;
    ...
    public void refreshUI(){
        ...
        float mMileage = mainActivity.localService.mCont.todayMileage;
        long mTotalTime = mainActivity.localService.mCont.todayTotalTime;
        float mSpeedMax = mainActivity.localService.mCont.todaySpeedMax;
        float mSpeedAvg = mainActivity.localService.mCont.todaySpeedAvg;
        float mAltitudeMax = mainActivity.localService.mCont.todayAltitudeMax;
        float mAltitudeMin = mainActivity.localService.mCont.todayAltitudeMin;
